...
class SystemRegistrationForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form->addAction('Voltar', new TAction(['LoginForm', 'onShow']), 'fa: fa-chevron-circle-left #69aa46');
        ...
        $name->placeHolder = "Ex: Seu primeiro e ultimo nome";
        $login->placeHolder = "Ex: 012345";
        $email->placeHolder = "Ex: voce@suaempresa.com";
        
        
        $name->setTip("Primeira letra é sempre maiúscula");
        $login->setTip("Se Registro de usuário");
        $email->setTip("Seu e-mail da empresa");
        
        $this->form->addFields( [new TLabel(_t('Login'), 'red', 'bold')],    [$login] );
