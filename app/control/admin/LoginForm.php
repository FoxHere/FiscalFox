...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btn = $this->form->addAction(' Tudo Pronto, Vamos! ', new TAction([$this, 'onLogin']), 'fas fa-user');
        $btn->class = 'btn btn-sm bg-light-blue';
        ...
        $h3 = new TElement('h1');
        $h3->style = 'text-align:center;font-size:30px;font:bold;color:white';
        $h3->add("<b class='bould'> Bem vindo ao sistema</b><br> <img  src='app/templates/theme3/img/icons8-2.png'><b class='bould'> FiscalFox</b>");
