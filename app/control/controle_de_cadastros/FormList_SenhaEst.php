...
class FormList_SenhaEst extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'TblSenhasestaduais';
    private static $primaryKey = 'id';
    private static $formName = 'form_list_TblSenhasestaduais';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Cadastro de Senhas - Estaduais");
        ...
        //$tbn_procurar->setAction(new TAction([$this, 'btn_procurar']), "tbn_procurar");
        //$tbn_procurar->addStyleClass('btn-default');
        //$tbn_procurar->setImage('fas:search #000000');
        ...
        $loja_id->setSize('98%');
        $buscaUF->setSize('95%');
        $buscaLoja->setSize('99%');

        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null)],[$id]);
        $row1->layout = [' col-sm-1 control-label',' col-sm-2'];
        $row2 = $this->form->addFields([new TLabel("Loja:", '#ff0000', '14px', null)],[$loja_id],[new TLabel("UF:", '#ff0000', '14px', null)],[$uf_id],[new TLabel("Login:", '#ff0000', '14px', null)],[$login],[new TLabel("Senha:", '#ff0000', '14px', null)],[$senha]);
        ...
        $row3 = $this->form->addFields([new TLabel("Local de declaração:", '#ff0000', '14px', null)],[$local]);
        $row3->layout = [' col-sm-1 control-label',' col-sm-9'];
        $row4 = $this->form->addContent([new TFormSeparator("Filtro de busca", '#333333', '18', '#eeeeee')]);
        $row5 = $this->form->addFields([new TLabel("Loja:", null, '14px', null)],[$buscaLoja],[new TLabel("UF:", null, '14px', null)],[$buscaUF]);
        $row5->layout = [' col-sm-1 control-label',' col-sm-2',' col-sm-1 control-label',' col-sm-1'];
        ...
        $action_onEdit = new TDataGridAction(array('FormList_SenhaEst', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FormList_SenhaEst', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Controle de cadastros","Estaduais"]));
    ...
    public function onEdit($param = null) 
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TblSenhasestaduais($key); // instantiates the Active Record 
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TblSenhasestaduais($key, FALSE); 
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new TblSenhasestaduais(); // create an empty object 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TblSenhasestaduais
