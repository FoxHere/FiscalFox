...
class FormList_categoria extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'TblCategoria';
    private static $primaryKey = 'id';
    private static $formName = 'form_list_TblCategoria';
    ...
    public function __construct()
    {
        ...
        $id->setSize('100%');
        $categoria->setSize('58%');

        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', 'B', '100%'),$id],[],[new TLabel("Categoria:", '#ff0000', '14px', 'B', '100%'),$categoria]);
        $row1->layout = [' col-sm-2',' col-sm-1','col-sm-6'];
        ...
        $action_onEdit = new TDataGridAction(array('FormList_categoria', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FormList_categoria', 'onDelete'));
    ...
    public function onEdit($param = null) 
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TblCategoria($key); // instantiates the Active Record 
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TblCategoria($key, FALSE); 
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new TblCategoria(); // create an empty object 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TblCategoria
