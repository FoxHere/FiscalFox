...
class List_Prazo extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TblPrazos';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Prazos e Obrigações");
        ...
        $row1 = $this->form->addContent([new TFormSeparator("Filtro", '#333333', '18', '#eeeeee')]);
        $row2 = $this->form->addFields([new TLabel("Id:", null, '14px', null)],[$id],[],[]);
        $row3 = $this->form->addFields([new TLabel("UF:", null, '14px', null)],[$uf_id]);
        ...
        $container->add(TBreadCrumb::create(["Consultas","Prazos e Obrigações"]));
