...
class SimpleList_Resp extends TPage
{
    ...
    private static $formName = 'simpleList_TblResponsaveis';
    ...
    public function __construct()
    {
        ...
        $column_responsavel = new TDataGridColumn('responsavel', "Responsáveis", 'left');
        $column_re = new TDataGridColumn('re', "RE", 'left');
        $column_grupo = new TDataGridColumn('tbl_grupo->grupo', "Grupo", 'left');
        $column_sexo = new TDataGridColumn('tbl_sexo->sexo', "Sexo", 'Left');
        ...
        $container->add(TBreadCrumb::create(["Consultas","Responsáveis"]));
        $container->add($panel);
