...
class List_SenhaEst extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TblSenhasestaduais';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Consulta de senhas estaduais");
        ...
        //$row1 = $this->form->addContent([new TFormSeparator("Filtros de busca", '#333333', '18', '#eeeeee')]);
        //$row2 = $this->form->addFields([new TLabel("Id:", null, '14px', null,"B")],[$id],[],[]);
        $row3 = $this->form->addFields([new TLabel("Loja:", null, '14px', 'B')],[$loja_id],[new TLabel("UF:", null, '14px','B')],[$uf_id]);
        $row3->layout = [' col-sm-1 control-label',' col-sm-2',' col-sm-1 control-label',' col-sm-2'];
        ...
        $container->add(TBreadCrumb::create(["Consultas","Estaduais"]));
