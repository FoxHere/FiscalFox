...
class TblDescrimpFormList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'TblDescrimp';
    private static $primaryKey = 'id';
    private static $formName = 'form_list_TblDescrimp';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Cadastro de descrição");
        ...
        $btn_onclear = $this->form->addHeaderAction("Limpar formulário", new TAction([$this, 'onClear']), 'fas:eraser #dd5a43');
        ...
        $action_onEdit = new TDataGridAction(array('TblDescrimpFormList', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TblDescrimpFormList', 'onDelete'));
    ...
    public function onEdit($param = null) 
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new TblDescrimp($key); // instantiates the Active Record 
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TblDescrimp($key, FALSE); 
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new TblDescrimp(); // create an empty object 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TblDescrimp
