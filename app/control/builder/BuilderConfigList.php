...
class BuilderConfigList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $file = $this->datagrid->addColumn( new TDataGridColumn('file', _t('File'), 'left') );
        
        $action = new TDataGridAction(['BuilderConfigForm', 'onEdit'],   ['file'=>'{file}'] );
        $this->datagrid->addAction($action, _t('Edit'), 'far:edit blue');
        ...
        $panel->addHeaderActionLink(_t('New'), new TAction(['BuilderConfigForm', 'onShow'], ['register_state'=>'false']), 'fas:plus green');
